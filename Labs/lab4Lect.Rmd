...
## Machine Learning
- Data Storage: Short/long term memory, and CPU. Storing and retreiving data is foundational
- Abstraction: Assigning meaning to stored data. Modes can be mathematical, relational, logical, clustered.
- Generalization: Turn abstracted knowledge into a reuseable form. 
- Evaluation: was the model succesful or not?
...
## Machine Learning Ethics
(https://www.forbes.com/sites/kashmirhill/2012/02/16/how-target-figured-out-a-teen-girl-was-pregnant-before-her-father-did/#26fbc4f16668)
...
Say that you are trying to classify different types of 311 calls that are coming into your government office. What kind of themes would be look for? Could this call be about parking, the subway, graffiti, rats? and how many of these topics are most closely related to eachother?

What about whether or not an apartment listing is in Manhattan or in the Bronx? What attributes would you need to make this classification... price, sq footage, amenities, elevation, number of floors, number of units in building, single family or not?

## Nearest Neighbor Classification

This technique is used when you have unlabeled data and are looking to classify them by simialrity. It implores mathematical distances to cluster like results.


## K-nearest neighbors (k-NN)

this algorithm can be used for classification and is quite simple. While it is fast and simple, the output isn't a model but rather a one-time snapshot of realtionships of different variables. 
...
This is a good way to view supervised learning algorithms. The Prediction error for any algorithm can be broken into bias error, variance error, and irreducible error. The irreducible error like the name suggests cannot be reduced which accounts for unkown factors that can arise from the way we frame the problem. 
...
you will programatically run k-means with numerous k values like 1-10 and calculat the sum of squared errors (SSE). Once you have the SSEs for the k values, you can plot them out. We does this because we want to minimized distance from the mean.
