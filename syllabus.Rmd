...
The end of the class will be acompanied by a 311 categorization challenege and report. The final report will document data/methods, including commented code, and description of analysis and conclusions. 
...
* Reading - The Rise of Statistical Thinking | Porter
* Reading Response 1
...
* Reading - Trust in Numbers & Rethinking Objectivity | Porter & Megill
* Reading Reponse 2 
...
* **Regression Week**
* Linear Regression
* Reading - Critical Theory of Technology | Feenberg
* Reading Reponse 3

#### Week 6 - 2/26/2019
* **Regression Week**
* Generalized Linear Models
* Assignment 5 - Mulitvariate Regression + ElasticNet
...
* Assignment 8 - NLP
* Reading -  Order without Design | Bertaud
* Reading Reponse 5
...
* Assignment 9 - Scoping + Data (due in two weeks)
...
* Sf
* Rgdal
* Assignment 10 - Geocomputation
* Reading -Weapons of Math Destruction | O'Neill
* Reading Reponse 6
